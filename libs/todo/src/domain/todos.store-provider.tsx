...
export function TodosStoreProvider({ initialTodos, setAllTodos, children }: TodosProviderProps) {
  const todosStore = useRef(createTodosStore({ initialTodos, setAllTodos }));
